...
public:
	...
	MedianFlowMultiTracker();
	virtual ~MedianFlowMultiTracker();
	void cleanPreviousData();
	void track(const cv::Mat &prevImg, const cv::Mat &currImg, cv::Rect *prevBB,  UUID* id, int* status, int numRects);
};
